...
#include "GUI.h"
#include "DIALOG.h"
/* Phase 8b 第3次 段階5-4c-3 (#57): legacy では Generated/Resource.h を subdir prefix で
 * 参照していたが、v3 では aw/Source/Generated を include path に直接追加済 (段階5-1) のため
 * subdir prefix なしで include できる。 */
#include "Resource.h"
