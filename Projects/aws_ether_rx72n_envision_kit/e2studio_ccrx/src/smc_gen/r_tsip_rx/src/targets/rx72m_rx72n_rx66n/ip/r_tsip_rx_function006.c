...
void RX72M_RX72N_RX66N_func006(void)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX72M_RX72N_RX66N_func100(change_endian_long(0x4e523a48u), change_endian_long(0x6fbe758bu), change_endian_long(0x2f8912c3u), change_endian_long(0xec3eed89u));
    ...
    RX72M_RX72N_RX66N_func100(change_endian_long(0x643eb561u), change_endian_long(0xdd71efb2u), change_endian_long(0xc3cf1516u), change_endian_long(0x75edc565u));
    TSIP.REG_24H.WORD = 0x00001dc0u;
    /* WAIT_LOOP */
    while (0u != TSIP.REG_24H.BIT.B21)
    {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX72M/RX72M_func006.prc
 *********************************************************************************************************************/
