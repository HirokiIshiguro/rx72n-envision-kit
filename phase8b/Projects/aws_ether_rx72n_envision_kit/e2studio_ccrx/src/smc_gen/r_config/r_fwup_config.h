...
#define FWUP_CFG_USER_SHA256_INIT_ENABLED    (1)
#define FWUP_CFG_USER_SHA256_INIT_FUNCTION     ota_sha256_init_function

#define FWUP_CFG_USER_SHA256_UPDATE_ENABLED    (1)
#define FWUP_CFG_USER_SHA256_UPDATE_FUNCTION     ota_sha256_update_function

#define FWUP_CFG_USER_SHA256_FINAL_ENABLED    (1)
#define FWUP_CFG_USER_SHA256_FINAL_FUNCTION     ota_sha256_final_function

#define FWUP_CFG_USER_VERIFY_ECDSA_ENABLED    (1)
#define FWUP_CFG_USER_VERIFY_ECDSA_FUNCTION     ota_verify_ecdsa_function

#define FWUP_CFG_USER_GET_CRYPT_CONTEXT_ENABLED    (1)
#define FWUP_CFG_USER_GET_CRYPT_CONTEXT_FUNCTION     ota_get_crypt_context_function

#define FWUP_CFG_USER_FLASH_OPEN_ENABLED    (1)
#define FWUP_CFG_USER_FLASH_OPEN_FUNCTION     ota_flash_open_function

#define FWUP_CFG_USER_FLASH_CLOSE_ENABLED    (1)
#define FWUP_CFG_USER_FLASH_CLOSE_FUNCTION     ota_flash_close_function

#define FWUP_CFG_USER_FLASH_ERASE_ENABLED    (1)
#define FWUP_CFG_USER_FLASH_ERASE_FUNCTION     ota_flash_erase_function

#define FWUP_CFG_USER_FLASH_WRITE_ENABLED    (1)
#define FWUP_CFG_USER_FLASH_WRITE_FUNCTION     ota_flash_write_function

#define FWUP_CFG_USER_FLASH_READ_ENABLED    (1)
#define FWUP_CFG_USER_FLASH_READ_FUNCTION     ota_flash_read_function

#define FWUP_CFG_USER_BANK_SWAP_ENABLED    (1)
#define FWUP_CFG_USER_BANK_SWAP_FUNCTION     ota_bank_swap_function
