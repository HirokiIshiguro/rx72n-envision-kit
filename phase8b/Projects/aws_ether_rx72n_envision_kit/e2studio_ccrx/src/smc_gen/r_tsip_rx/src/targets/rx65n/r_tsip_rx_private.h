...
#include "iodefine/r_tsip_rx65n_iodefine.h"
...
void RX65NHU_func000(uint32_t *InData_PaddedMsg, int32_t MAX_CNT);
void RX65NHU_func001(void);
void RX65NHU_func002(void);
void RX65NHU_func003(uint32_t* ARG1);
void RX65NHU_func004(uint32_t ARG1);
void RX65NHU_func005(uint32_t ARG1);
void RX65NHU_func006(void);
void RX65NHU_func007(void);
void RX65NHU_func008(void);
void RX65NHU_func009(void);
void RX65NHU_func010(uint32_t ARG1);
void RX65NHU_func011(uint32_t *ARG1);
void RX65NHU_func015(void);
void RX65NHU_func022(void);
void RX65NHU_func023(void);
void RX65NHU_func025(uint32_t ARG1);
void RX65NHU_func027(uint32_t ARG1);
void RX65NHU_func028(uint32_t ARG1);
void RX65NHU_func030(void);
void RX65NHU_func031(uint32_t *ARG1);
void RX65NHU_func032(void);
void RX65NHU_func040(uint32_t ARG1);
void RX65NHU_func041(uint32_t ARG1);
void RX65NHU_func050(uint32_t ARG1);
void RX65NHU_func051(void);
void RX65NHU_func052(uint32_t ARG1);
void RX65NHU_func053(uint32_t ARG1);
void RX65NHU_func054(uint32_t ARG1, uint32_t ARG2);
void RX65NHU_func060(void);
void RX65NHU_func061(void);
void RX65NHU_func070(void);
void RX65NHU_func071(void);
void RX65NHU_func072(void);
void RX65NHU_func073(uint32_t *ARG1);
void RX65NHU_func074(void);
void RX65NHU_func075(void);
void RX65NHU_func080(void);
void RX65NHU_func100(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3, uint32_t ARG4);
void RX65NHU_func101(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3, uint32_t ARG4);
void RX65NHU_func102(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3, uint32_t ARG4);
void RX65NHU_func103(void);
void RX65NHU_func200(void);
void RX65NHU_func202(void);
void RX65NHU_func205(void);
void RX65NHU_func206(void);
void RX65NHU_func207(void);
...
void RX65NHU_func312(uint32_t ARG1);
void RX65NHU_func313(uint32_t ARG1);
void RX65NHU_func314(uint32_t ARG1);
void RX65NHU_func315(uint32_t ARG1);
void RX65NHU_func316(void);
void RX65NHU_func317(void);
void RX65NHU_func318(void);
void RX65NHU_func319(uint32_t ARG1);
void RX65NHU_func320(uint32_t ARG1);
void RX65NHU_func321(uint32_t ARG1);
void RX65NHU_func322(uint32_t ARG1);
void RX65NHU_func323(void);
void RX65NHU_func324(void);
void RX65NHU_func325(void);
void RX65NHU_func401(void);
void RX65NHU_func402(void);
